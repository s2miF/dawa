$(document).ready( function() {
	...
	$(function (){
		...
		beforeSend:function(){
			$("#result").html("<img src='images/loading.gif' width='100px' style='margin-right: 350px;'/>")
			}
	...
	$(function (){
		...
		beforeSend:function(){
			$("#log_result").html("<img src='images/loading.gif' width='100px' style='margin-right: 350px;'/>")
			}
			,success:function(data){
